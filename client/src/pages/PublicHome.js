      ...
      <div className="page-wrapper">
                ...
                <div className="header-dropdown-link">
                  <div className="dropdown compare-dropdown">
                    ...
                    >
                      ...
                      <span className="compare-txt">Sign In / SIgn up</span>
                    </a>
        ...
        <main className="main">
            ...
            <div className="container">
              <div className="heading heading-flex heading-border mb-3">
                <div className="heading-left">
                  <h2 className="title">Hot Deals Products <a  href= "#" style={{ fontSize : "16px", color : "gray", fontWeight : "400", paddingLeft : "1rem"}}>View All</a></h2>
          ...
          <div className="container electronics">
            <div className="heading heading-flex heading-border mb-3">
              <div className="heading-left">
                <h2 className="title">Electronics <a href="#" style={{ fontSize: "16px", color: "gray", fontWeight: "400", paddingLeft: "1rem" }}>View All</a></h2>
                {/* End .title */}
              </div>
              {/* End .heading-left */}
              <div className="heading-right">
          ...
          <div className="container furniture">
            <div className="heading heading-flex heading-border mb-3">
              <div className="heading-left">
                <h2 className="title">Furniture<a href="#" style={{ fontSize: "16px", color: "gray", fontWeight: "400", paddingLeft: "1rem" }}>View All</a></h2>
                {/* End .title */}
              </div>
              {/* End .heading-left */}
              <div className="heading-right">
          ...
          <div className="container clothing ">
            <div className="heading heading-flex heading-border mb-3">
              <div className="heading-left">
                <h2 className="title">Clothing &amp; Apparel<a href="#" style={{ fontSize: "16px", color: "gray", fontWeight: "400", paddingLeft: "1rem" }}>View All</a></h2>
                {/* End .title */}
              </div>
              {/* End .heading-left */}
              <div className="heading-right">
          ...
          {/* End .mb-3 */}
          <div className="container">
            <h2 className="title title-border mb-5">Shop by Brands<a href="#" style={{ fontSize: "16px", color: "gray", fontWeight: "400", paddingLeft: "1rem" }}>View All</a></h2>
            {/* End .title */}
            <div
